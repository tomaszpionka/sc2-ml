# Phase 01 Stage 05 Exit Gate Memo — aoe2companion
...
Reference matches: 2,006,913 (4,013,826 player rows).
...
ANOVA ICC (primary) = 0.003013 [0.001724, 0.004202] — below range [0.05, 0.20].
...
max |d| across quarters = 0.0923 (< 0.2 threshold). Duration distribution is
