...
def run_source_audit(
    ...
    if output_path is None:
        output_path = DATASET_ARTIFACTS_DIR / "00_01_source_audit.json"
...
def validate_tournament_name_extraction(
    ...
    if output_path is None:
        output_path = DATASET_ARTIFACTS_DIR / "00_02_tournament_name_validation.txt"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def write_replay_id_spec(
    ...
    if output_path is None:
        output_path = DATASET_ARTIFACTS_DIR / "00_03_replay_id_spec.md"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def run_path_a_smoke_test(
    ...
    # Write report
    if output_path is None:
        output_path = DATASET_ARTIFACTS_DIR / "00_04_path_a_smoke_test.md"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def run_full_path_a_ingestion(
    ...
    audit_path = DATASET_ARTIFACTS_DIR / "00_01_source_audit.json"
    audit_total = None
    ...
    if output_path is None:
        output_path = DATASET_ARTIFACTS_DIR / "00_05_full_ingestion_log.txt"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def run_path_b_extraction(
    ...
    if output_path is None:
        output_path = DATASET_ARTIFACTS_DIR / "00_07_path_b_extraction_log.txt"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def validate_path_a_b_join(
    ...
    if output_path is None:
        output_path = DATASET_ARTIFACTS_DIR / "00_08_join_validation.md"
    output_path.parent.mkdir(parents=True, exist_ok=True)
