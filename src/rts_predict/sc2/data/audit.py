...
def run_source_audit(
    ...
    if output_path is None:
        output_path = REPORTS_DIR / "00_source_audit.json"
...
def validate_tournament_name_extraction(
    ...
    if output_path is None:
        output_path = REPORTS_DIR / "00_tournament_name_validation.txt"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def write_replay_id_spec(
    ...
    if output_path is None:
        output_path = REPORTS_DIR / "00_replay_id_spec.md"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def run_path_a_smoke_test(
    ...
    # Write report
    if output_path is None:
        output_path = REPORTS_DIR / "00_path_a_smoke_test.md"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def run_full_path_a_ingestion(
    ...
    if output_path is None:
        output_path = REPORTS_DIR / "00_full_ingestion_log.txt"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def run_path_b_extraction(
    ...
    if output_path is None:
        output_path = REPORTS_DIR / "00_path_b_extraction_log.txt"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def validate_path_a_b_join(
    ...
    if output_path is None:
        output_path = REPORTS_DIR / "00_join_validation.md"
    output_path.parent.mkdir(parents=True, exist_ok=True)
...
def validate_map_translation_coverage(
    ...
    if output_path is None:
        output_path = REPORTS_DIR / "00_map_translation_coverage.csv"
    output_path.parent.mkdir(parents=True, exist_ok=True)
